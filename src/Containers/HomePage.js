...
const HomePage = () => {
    ...
    useEffect(() => {
        ...
        ScrollReveal().reveal('.scroll-reveal', {
         ...
         // Sprawdź, czy token użytkownika istnieje w localStorage
    ...
    return (
        <div className="pb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 ">
                ...
                <img srcSet={RSA} className="w-auto h-auto max-w-full max-h-full object-cover rounded-lg scroll-reveal" alt="Klucz RSA"/>
                ...
                <div className=" mx-auto max-w-screen-xl text-center py-24 scroll-reveal">
                    ...
                    <ol className="w-full space-y-0  ml-6">
                        ...
                        <li className="mt-2 flex items-center text-gray-500 dark:text-gray-400 rtl:space-x-reverse">
                            ...
                            <span>
                                    <h3 className="font-medium leading-tight">Po wygenerowaniu, pobierz swój klucz prywatny i klucz publiczny.</h3>
                                </span>
                        </li>
                    </ol>
                </div>
                ...
                <div className=" mx-auto max-w-screen-xl text-center py-24 scroll-reveal">
                    ...
                    <div className="my-4 flex items-center">
                        <p className="mb-8 text-lg font-normal text-gray-500 lg:text-xl lg:px-4 dark:text-gray-400">
                            Bezpieczne szyfrowanie dokumentów PDF, przy użyciu algorytmu AES.
                        </p>
                        </div>
                    <ol className="w-full space-y-0  ml-6">
                        <li className="mt-2 flex items-center text-gray-500 dark:text-gray-400 rtl:space-x-reverse">
                            ...
                            <span>
                                    <h3 className="font-medium leading-tight">Dodaj plik PDF, który chcesz zaszyfrować.</h3>
                                </span>
                        </li>
                        <li className="mt-2 flex items-center text-gray-500 dark:text-gray-400 rtl:space-x-reverse">
                                <span className="mr-2 flex items-center justify-center w-8 h-8 border border-gray-500 rounded-full shrink-0 dark:border-gray-400">
                        ...
                        <li className="mt-2 flex items-center text-gray-500 dark:text-gray-400 rtl:space-x-reverse">
                            ...
                            <span>
                                    <h3 className="font-medium leading-tight">Pobierz zaszyfrowane dane i bezpiecznie je prześlij do odbiorcy.</h3>
                                </span>
                        </li>
                    </ol>
                </div>

                <img srcSet={AES} className="w-auto h-auto max-w-full max-h-full object-cover rounded-lg scroll-reveal" alt="Algorytm RSA"/>

                <img srcSet={Signature} className="w-auto h-auto max-w-full max-h-full object-cover rounded-lg scroll-reveal" alt="Cyfrowy Podpis"/>
                ...
                <div className=" mx-auto max-w-screen-xl text-center py-24 scroll-reveal">
                    ...
                    <ol className="w-full space-y-0  ml-6">
                        ...
                        <li className="mt-2 flex items-center text-gray-500 dark:text-gray-400 rtl:space-x-reverse">
                            ...
                            <span>
                                    <h3 className="font-medium leading-tight">Pobierz podpis cyfrowy, potwierdzający autentyczności twojego dokumentu.</h3>
                                </span>
                        </li>
                    </ol>
                </div>
                ...
                <img srcSet={Verify} className="w-auto h-auto max-w-full max-h-full object-cover rounded-lg scroll-reveal" alt="Weryfikacja Podpisu"/>
